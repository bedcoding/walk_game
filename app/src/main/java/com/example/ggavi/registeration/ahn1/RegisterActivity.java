    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        validateButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(userID.equals(""))
                {
                    new CustomConfirmDialog().showConfirmDialog(RegisterActivity.this,"아이디는 빈칸일 수 없습니다.",true);
                    return;
                }
        ...
        registerButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(!validate)
                {
                    new CustomConfirmDialog().showConfirmDialog(RegisterActivity.this,"중복체크를 해주세요.",true);
                    return;
                }
                ...
                Response.Listener<String> responseListener = new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        try
                        {
                            ...
                            // 만약 사용할 수 있는 아이디라면
                            if(success) {
                                new CustomConfirmDialog().showConfirmDialog(RegisterActivity.this,"회원 등록에 성공하였습니다.",false);
                                finish();           //회원가입 창을 닫는다.
                            }

                            // 중복체크 실패 (사용할 수 없는 아이디)
                            else {
                                new CustomConfirmDialog().showConfirmDialog(RegisterActivity.this,"회원 등록에 실패하였습니다.",true);
                            }
                        }
