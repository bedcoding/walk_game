...
public class open2_CourseAdapter2 extends RecyclerView.Adapter<open2_CourseAdapter2.ViewHolder>  {
    ...
    public open2_CourseAdapter2(Context context, List<open2_CourseItem> items, int item_layout) {
        ...
        public ViewHolder(View itemView) {
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    Intent intent = new Intent(v.getContext(), open2_PlaceThirdActivity2.class);
