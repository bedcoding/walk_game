...
public class open2_CourseAdapter3 extends RecyclerView.Adapter<open2_CourseAdapter3.ViewHolder>  {
    ...
    public open2_CourseAdapter3(Context context, List<open2_CourseItem> items, int item_layout) {
        ...
        public ViewHolder(View itemView) {
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    Intent intent = new Intent(v.getContext(), open2_PlaceThirdActivity3.class);
